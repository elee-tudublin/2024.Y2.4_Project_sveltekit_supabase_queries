	...
	<div class="row">
		<div class="col-sm-2">
			...
			<div id="computers" class="list-group">
				<!-- computer links -->
				<button on:click={filterByComputer} class="list-group-item list-group-item-action"> All Computers </button>
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th class="click-text" on:click={() => sort_by_col('computer_id')}><i class={ table_sort['computer_id'] ? 'bi bi-sort-down' : 'bi bi-sort-up'}></i>Computer</th>
							<th class="click-text" on:click={() => sort_by_col('description')}><i class={ table_sort['description'] ? 'bi bi-sort-down' : 'bi bi-sort-up'}></i>Description</th>
							<th>Level</th>
							<th>Service</th>
							<th>Type</th>
							<th>User</th>
